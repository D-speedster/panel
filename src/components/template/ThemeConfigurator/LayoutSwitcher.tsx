...
const layouts = [
    {
        ...
        label: 'قابل جمع شدن',
        src: '/admin-panel/img/thumbs/layouts/classic.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/classic-dark.jpg',
        svg: <CollapsibleSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_STACKED_SIDE,
        label: 'چیده شده',
        src: '/admin-panel/img/thumbs/layouts/modern.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/modern-dark.jpg',
        svg: <StackedSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_TOP_BAR_CLASSIC,
        label: 'نوار بالایی',
        src: '/admin-panel/img/thumbs/layouts/stackedSide.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/stackedSide-dark.jpg',
        svg: <TopBarClassicSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_FRAMELESS_SIDE,
        label: 'بی قاب',
        src: '/admin-panel/img/thumbs/layouts/simple.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/simple-dark.jpg',
        svg: <FrameLessSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_CONTENT_OVERLAY,
        label: 'روی هم قرار دادن',
        src: '/admin-panel/img/thumbs/layouts/decked.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/decked-dark.jpg',
        svg: <ContentOverlaySvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_BLANK,
        label: 'خالی',
        src: '/admin-panel/img/thumbs/layouts/blank.jpg',
        srcDark: '/admin-panel/img/thumbs/layouts/blank-dark.jpg',
